<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkTransactions.aspx.cs" Inherits="WebApplication6.checkTransactions" %>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 offset-lg-2 header-text">
          <h2>Transactions</h2>
          <p>You have made the following transactions</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="top-categories">
    <div class="container">
      <div class="row", style="color: white">
            ...
            <asp:GridView ID ="ItemGrid" HorizontalAlign="Center"  ItemStyle-Width="100%" runat="server" ></asp:GridView>
