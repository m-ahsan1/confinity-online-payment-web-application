<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="requestLoan.aspx.cs" Inherits="WebApplication6.requestLoan" %>
                ...
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li class="has-sub">
                          ...
                          <li><asp:HyperLink NavigateUrl="checkTransactions.aspx" Text="View Transactions" runat="server" /></li>
                            </ul>
                        </li>
        ...
        <div class="col-lg-10 offset-lg-1">
          <div class="header-text">
            ...
            <asp:TextBox ID="txtLoanAmount"  runat="server"></asp:TextBox>
                ...
                <center>  <asp:Label ID="buttonReq" runat="server" ></asp:Label></center>
          
            <div class="col-lg-12">
                <fieldset>
                    <asp:Button ID="reqButton" runat="server" Text="REQUEST" BorderColor="#00ccff" BackColor="#00ccff" class="orange-button" PostBackUrl="~/transaction.aspx" OnClick="submitbutton_Click"/>
